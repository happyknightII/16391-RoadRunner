package org.firstinspires.ftc.teamcode.opmode.competitioncode.vision;
...
public class ExperimentPipe extends OpenCvPipeline {
     ...
     */
    public ExperimentPipe(int width) {
        this.width = width;
    }

    public ExperimentPipe() {
        this.width = 100;
    }
    ...
    public Mat processFrame(Mat input) {
        ...
        Scalar lowHSV = new Scalar(0, 100, 100); // lower bound HSV for yellow
        Scalar highHSV = new Scalar(20, 255, 255); // higher bound HSV for yellow
        Mat thresh = new Mat();
        ...
        for (int i = 0; i != boundRect.length; i++) {
            ...
            Imgproc.rectangle(mat, boundRect[i], new Scalar(60, 255, 255));
        }
        ...
        Mat out = new Mat();
        Imgproc.cvtColor(mat, out, Imgproc.COLOR_HSV2RGB_FULL);
        return out; // return the mat with rectangles drawn
    }
